...
""")
    ...
    print(f"\n✨ Simplified CSV Format (NEW!)")
    print("-" * 40)
    print("🚀 MINIMAL REQUIRED COLUMNS (Only 3!):")
    print("  - test_name: Unique name for the test")
    print("  - test_type: ip, hostname, url, dns, dns_grid, or page_load")
    print("  - target: IP address, hostname, or URL to test")
    
    print("\n🎯 SENSIBLE DEFAULTS APPLIED:")  
    print("  - site_name: 'Default Site' (auto-created)")
    print("  - labels: 'csv-managed' (for cleanup tracking)")
    print("  - dns_servers: '8.8.8.8,1.1.1.1' (for DNS tests)")
    print("  - agent_names: Empty (uses site-based agents)")
    
    print("\n📋 OPTIONAL COLUMNS (All have defaults):")
    print("  - site_name: Custom site name")
    print("  - labels: Comma-separated labels")
    print("  - dns_servers: DNS servers for DNS/DNS grid tests")
    print("  - agent_names: Specific agent names (comma-separated)")
    
    print("\n🏢 ADDITIONAL SITE COLUMNS (for new sites):")
