...
class TestGenerator:
    ...
    def create_labels_for_test_type(self, test_type: str, environment: Optional[str] = None, region: Optional[str] = None) -> List[str]:
        """
    ...
    def create_multi_site_test_suite(
        ...
        for site_config in site_configs:
            ...
            # Combine labels
            test_labels = (global_labels or []) + site_labels + [f"site-id:{site_id}", f"site-name:{site_name}"]
