...
class SyntheticsClient:
    ...
    def update_test(self, test_id: str, test: Test) -> UpdateTestResponse:
        ...
        data = self._make_request("PUT", f"/tests/{test_id}", data=request.model_dump(exclude_none=True))
    ...
    def set_test_status(self, test_id: str, status: TestStatus) -> SetTestStatusResponse:
        ...
        data = self._make_request("PUT", f"/tests/{test_id}/status", data=request.model_dump(exclude_none=True))
    ...
    def list_labels(self) -> ListLabelsResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to list labels: {response.text}", response.status_code)
    ...
    def create_label(self, label: Label) -> CreateLabelResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to create label: {response.text}", response.status_code)
    ...
    def update_label(self, label_id: str, label: Label) -> UpdateLabelResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to update label: {response.text}", response.status_code)
    ...
    def delete_label(self, label_id: str) -> DeleteLabelResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to delete label: {response.text}", response.status_code)
    ...
    def create_site(self, site: Site) -> CreateSiteResponse:
        """
        Create a new site.
        
        Args:
            site: Site configuration to create
            
        Returns:
            Response containing the created site
        """
        request = CreateSiteRequest(site=site)
        base_url = "https://grpc.api.kentik.com/site/v202211"
        url = urljoin(base_url + "/", "sites")
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to create site: {response.text}", response.status_code)

    def update_site(self, site_id: str, site: Site) -> UpdateSiteResponse:
        """
        Update an existing site.
        
        Args:
            site_id: ID of the site to update
            site: Updated site configuration
            
        Returns:
            Response containing the updated site
        """
        request = UpdateSiteRequest(site=site)
        base_url = "https://grpc.api.kentik.com/site/v202211"
        url = urljoin(base_url + "/", f"sites/{site_id}")
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to update site: {response.text}", response.status_code)
    ...
    def delete_site(self, site_id: str) -> DeleteSiteResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to delete site: {response.text}", response.status_code)
    ...
    def list_site_markets(self) -> ListSiteMarketsResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to list site markets: {response.text}", response.status_code)
    ...
    def get_site_market(self, market_id: str) -> GetSiteMarketResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to get site market: {response.text}", response.status_code)
    ...
    def create_site_market(self, site_market: SiteMarket) -> CreateSiteMarketResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to create site market: {response.text}", response.status_code)

    def update_site_market(self, market_id: str, site_market: SiteMarket) -> UpdateSiteMarketResponse:
        """
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to update site market: {response.text}", response.status_code)
    ...
    def delete_site_market(self, market_id: str) -> DeleteSiteMarketResponse:
        ...
        if response.status_code == 200:
            ...
            raise SyntheticsAPIError(f"Failed to delete site market: {response.text}", response.status_code)