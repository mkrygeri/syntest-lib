...
class Agent(BaseModel):
    ...
    site_name: Optional[str] = Field(None, alias="siteName", description="Name of the site where agent is located")
    ...
    lat: Optional[float] = Field(None, description="Latitude of agent's location (signed decimal degrees)")
    long: Optional[float] = Field(None, description="Longitude of agent's location (signed decimal degrees)")
    last_authed: Optional[datetime] = Field(None, alias="lastAuthed", description="Timestamp of the last authorization")
    family: Optional[IPFamily] = None
    asn: Optional[int] = Field(None, description="ASN of the AS owning agent's public address")
    site_id: Optional[str] = Field(None, alias="siteId", description="ID of the site hosting the agent")
    ...
    test_ids: Optional[List[str]] = Field(None, alias="testIds", description="IDs of user's test running on the agent")
    local_ip: Optional[str] = Field(None, alias="localIp", description="Internal IP address of the agent")
    cloud_region: Optional[str] = Field(None, alias="cloudRegion", description="Cloud region hosting the agent")
    cloud_provider: Optional[str] = Field(None, alias="cloudProvider", description="Cloud provider hosting the agent")
    agent_impl: Optional[ImplementType] = Field(None, alias="agentImpl")
    labels: Optional[List[str]] = Field(None, description="List of names of labels associated with the agent")
    metadata: Optional[AgentMetadata] = None


class ActivationSettings(BaseModel):
    """Activation settings for health monitoring."""
    grace_period: Optional[str] = Field(None, alias="gracePeriod", description="Period of healthy status in minutes")
    time_unit: Optional[str] = Field(None, alias="timeUnit", description="Time unit for specifying time window (m | h)")
    time_window: Optional[str] = Field(None, alias="timeWindow", description="Time window for evaluating test")
    times: Optional[str] = Field(None, description="Number of occurrences triggering alarm activation")
...
class HealthSettings(BaseModel):
    ...
    latency_critical: Optional[float] = Field(None, alias="latencyCritical", description="Critical latency threshold (microseconds)")
    latency_warning: Optional[float] = Field(None, alias="latencyWarning", description="Warning latency threshold (microseconds)")
    packet_loss_critical: Optional[float] = Field(None, alias="packetLossCritical", description="Critical packet loss threshold (%)")
    packet_loss_warning: Optional[float] = Field(None, alias="packetLossWarning", description="Warning packet loss threshold (%)")
    jitter_critical: Optional[float] = Field(None, alias="jitterCritical", description="Critical jitter threshold (microseconds)")
    jitter_warning: Optional[float] = Field(None, alias="jitterWarning", description="Warning jitter threshold (microseconds)")
    http_latency_critical: Optional[float] = Field(None, alias="httpLatencyCritical", description="Critical HTTP latency threshold")
    http_latency_warning: Optional[float] = Field(None, alias="httpLatencyWarning", description="Warning HTTP latency threshold")
    http_valid_codes: Optional[List[int]] = Field(None, alias="httpValidCodes", description="Valid HTTP status codes")
    dns_valid_codes: Optional[List[int]] = Field(None, alias="dnsValidCodes", description="Valid DNS status codes")
    cert_expiry_warning: Optional[int] = Field(None, alias="certExpiryWarning", description="Certificate expiry warning (days)")
    cert_expiry_critical: Optional[int] = Field(None, alias="certExpiryCritical", description="Certificate expiry critical (days)")
    dns_valid_ips: Optional[str] = Field(None, alias="dnsValidIps", description="Expected DNS response IPs")
    dns_latency_critical: Optional[float] = Field(None, alias="dnsLatencyCritical", description="Critical DNS latency threshold")
    dns_latency_warning: Optional[float] = Field(None, alias="dnsLatencyWarning", description="Warning DNS latency threshold")
    per_agent_alerting: Optional[bool] = Field(None, alias="perAgentAlerting", description="Enable per-agent alerting")
    disabled_metrics: Optional[DisabledMetrics] = Field(None, alias="disabledMetrics")
    health_disabled: Optional[bool] = Field(None, alias="healthDisabled", description="Disable all health evaluation")
    throughput_critical: Optional[float] = Field(None, alias="throughputCritical", description="Critical throughput threshold")
    throughput_warning: Optional[float] = Field(None, alias="throughputWarning", description="Warning throughput threshold")
...
class GroupedAlertSetting(BaseModel):
    ...
    percent_of_src_group: Optional[int] = Field(None, alias="percentOfSrcGroup", description="Grouping percentage")
    filter_ids: Optional[List[int]] = Field(None, alias="filterIds", description="List of IDs to include")


class GroupedAlertSettings(BaseModel):
    """Grouped alert settings."""
    default: Optional[GroupedAlertSetting] = None
    overrides: Optional[List[GroupedAlertSetting]] = Field(None, description="Overrides to default settings")
...
class AlertingSettings(BaseModel):
    ...
    grouped_alert_settings: Optional[GroupedAlertSettings] = Field(None, alias="groupedAlertSettings")
...
class IpTest(BaseModel):
    ...
    use_local_ip: Optional[bool] = Field(None, alias="useLocalIp", description="Use local IP address")
...
class UrlTest(BaseModel):
    ...
    ignore_tls_errors: Optional[bool] = Field(None, alias="ignoreTlsErrors", description="Ignore TLS certificate errors")
...
class PageLoadTest(BaseModel):
    ...
    headers: Optional[Dict[str, str]] = Field(None, description="HTTP header values")
    ignore_tls_errors: Optional[bool] = Field(None, alias="ignoreTlsErrors", description="Ignore TLS certificate errors")
    css_selectors: Optional[Dict[str, str]] = Field(None, alias="cssSelectors", description="CSS selector values")
...
class FlowTest(BaseModel):
    ...
    target_refresh_interval_millis: Optional[int] = Field(None, alias="targetRefreshIntervalMillis", description="Refresh interval")
    max_providers: Optional[int] = Field(None, alias="maxProviders", description="Maximum number of IP providers")
    max_ip_targets: Optional[int] = Field(None, alias="maxIpTargets", description="Maximum number of target IPs")
    type: Optional[str] = Field(None, description="Autonomous test sub-type")
    inet_direction: Optional[str] = Field(None, alias="inetDirection", description="Address selection direction")
...
class TestSettings(BaseModel):
    ...
    agent_ids: Optional[List[str]] = Field(None, alias="agentIds", description="IDs of agents to run tasks")
    ...
    family: Optional[IPFamily] = None
    notification_channels: Optional[List[str]] = Field(None, alias="notificationChannels", description="Notification channel IDs")
...
class ListTestsResponse(BaseModel):
    ...
    invalid_count: Optional[int] = Field(None, alias="invalidCount", description="Number of invalid entries")
...
class MetricData(BaseModel):
    ...
    rolling_avg: Optional[int] = Field(None, alias="rollingAvg", description="Rolling average of metric")
    rolling_stddev: Optional[int] = Field(None, alias="rollingStddev", description="Rolling standard deviation")
...
class HTTPResults(BaseModel):
    ...
    dst_ip: Optional[str] = Field(None, alias="dstIp", description="IP address of probed target server")
...
class AgentResults(BaseModel):
    ...
    agent_id: Optional[str] = Field(None, alias="agentId", description="ID of the agent providing results")
    health: Optional[str] = Field(None, description="Overall health status")
    tasks: Optional[List[TaskResults]] = Field(None, description="List of results for individual tasks")
...
class PathTrace(BaseModel):
    """Path trace data."""
    as_path: Optional[List[int]] = Field(None, alias="asPath", description="AS path of the network trace")
    is_complete: Optional[bool] = Field(None, alias="isComplete", description="Whether response from target was received")
...
class NetNode(BaseModel):
    ...
    device_id: Optional[str] = Field(None, alias="deviceId", description="ID of corresponding device")
    site_id: Optional[str] = Field(None, alias="siteId", description="ID of site containing the device")


class Path(BaseModel):
    """Network path data."""
    agent_id: Optional[str] = Field(None, alias="agentId", description="ID of the agent generating path data")
    target_ip: Optional[str] = Field(None, alias="targetIp", description="IP address of path target")
    hop_count: Optional[Stats] = Field(None, alias="hopCount")
    max_as_path_length: Optional[int] = Field(None, alias="maxAsPathLength", description="Maximum AS path length")
...
class GetTraceForTestRequest(BaseModel):
    ...
    end_time: datetime = Field(alias="endTime", description="End timestamp")
    agent_ids: Optional[List[str]] = Field(None, alias="agentIds", description="List of agent IDs")
    target_ips: Optional[List[str]] = Field(None, alias="targetIps", description="List of target IP addresses")
